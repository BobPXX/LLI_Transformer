...
wait_time=1 #default=0.3
ep_time=100000 #default=30000
...
nodemap_remote_device.FindNode("ExposureTime").SetValue(ep_time)#default 30000
...
dataset_path=path+'dataset/PetImages/'
classes=os.listdir(dataset_path)
classes.sort()

pattern_path=path+'pattern/PetImages/'
...
all_files= [ [ None for y in range(12500) ]
...
for i in range(12500):
    for cl in range(len(classes)):
        if all_files[cl][i]!=None:
            ...
            pattern_add=pattern_path+classes[cl]+'/'+all_files[cl][i][:-4]+'.npy'
...
#====================================================================
output_filename=path+'pattern/PetImages'
dir_name=path+'pattern/PetImages'
